...
public class ImageHelper {
    ...
    public static void scale(InputStream in, OutputStream out, String width, String height, String format) {
        Validate.notNull(in);
        ...
        try {
            ...
            throw new ServerException(E.IMAGE, e);
        }
    }

    public static byte[] scale(byte[] in, String width, String height, String format) {
