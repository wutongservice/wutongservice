...
public class ErrorCode {
    ...
    public static final int CANT_COMMENT = BASE_ERROR + 12;
    public static final int CANT_LIKE = BASE_ERROR + 13;
    public static final int CANT_RESHARE = BASE_ERROR + 14;

    public static final int POST_HAS_DELETED = BASE_ERROR + 19;
    ...
    public static final int POLL_ERROR = PLATFORM_ERROR + 16;
    public static final int GROUP_NOT_EXISTS = PLATFORM_ERROR + 18;
    public static final int POLL_NOT_EXISTS = PLATFORM_ERROR + 24;

    public static final int EMPLOYEE_ERROR = PLATFORM_ERROR + 17;
    ...
    public static final int  REPEAT_MESSAGE = 1001;
