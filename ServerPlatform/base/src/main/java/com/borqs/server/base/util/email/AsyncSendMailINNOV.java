...
public class AsyncSendMailINNOV {
    private final static Logger log = LoggerFactory.getLogger(AsyncSendMailINNOV.class);
    private static AsyncSendMailINNOV _instance;
    ...
    private AsyncSendMailINNOV(Configuration config){
...
//    	smtpFromUserPassword = "borqsoms";
    ...
    synchronized public static AsyncSendMailINNOV getInstance(Configuration config){
    	if(_instance == null){
    		_instance = new AsyncSendMailINNOV(config);
    	}
    	return _instance;
    }
    ...
    public void asyncSendMailHTML(final String title, final String to,final String username, final String content, String type, String lang){
...
//	      	  	+ "		<a href=http://" + serverHost + "/search?q=com.borqs.qiupu target=_blank>http://" + serverHost + "/search?q=com.borqs.qiupu</a>";
    ...
    public void shutdown(){
        synchronized (AsyncSendMailINNOV.class) {
            if (shutdown) {
