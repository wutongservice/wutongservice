...
public class UserMocks {
    ...
    public static User newFullInfoUser(long userId, String pwd, String fullName) {
        ...
        user.setOrganization(
                new OrgInfo(OrgInfo.TYPE_WORK, "borqs", "title", "department", "wangjing", "dev", "symbol", "B-O-R-Q-S", "")
        );
        ...
        // work_history
        user.setWorkHistory(
                new WorkHistory("2011", "2012", "borqs", "title", "department", "wangjing", "dev", "symbol", "phoneticName")
        );
