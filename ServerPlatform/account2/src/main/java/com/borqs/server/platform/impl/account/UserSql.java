...
import com.borqs.server.platform.account2.PropertyEntry;
import com.borqs.server.platform.account2.User;
import com.borqs.server.platform.data.ValuesNewAccount;
...
public class UserSql {
    ...
    public static String updateUser(String table, User user) {
        ...
        return new Sql()
                ...
                .setValues(
                        ...
                        valueIf("status_updated_time", DateHelper.nowMillis(), user.getStatus() != null)
    ...
    public static List<String> updateProperties(String table, User user) {
        ...
        if (user.hasProperties()) {
            ...
            sqls.add(new Sql()
                    .deleteFrom(table)
                    .where("`user`=:user_id AND `key` IN ($keys)", "user_id", userId, "keys", StringHelper.join(keys, ","))
                    .toString());
