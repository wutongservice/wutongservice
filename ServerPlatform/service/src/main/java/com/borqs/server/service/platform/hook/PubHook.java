package com.borqs.server.service.platform.hook;

import com.borqs.server.base.conf.ConfigurableBase;
import com.borqs.server.base.data.Record;
import com.borqs.server.base.net.HostAndPort;
import com.borqs.server.service.platform.event.PlatformHook;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import redis.clients.jedis.Jedis;


public class PubHook extends ConfigurableBase implements PlatformHook {

    private static final Logger L = LoggerFactory.getLogger(PubHook.class);

    private Jedis getJedis() {
        String addr = getConfig().getString("platform.pubServer", null);
        if (addr == null)
            return null;
