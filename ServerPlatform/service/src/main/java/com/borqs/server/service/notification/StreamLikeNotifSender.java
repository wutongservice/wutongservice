...
public class StreamLikeNotifSender extends NotificationSender {
    ...
    public StreamLikeNotifSender(Platform p, Qiupu qiupu) {
        super(p, qiupu);
        isReplace = true;
    }
    ...
    protected List<Long> getScope(String senderId, Object... args) {
        ...
        if (getSettingKey().equals(Constants.NTF_MY_STREAM_LIKE)) {
                try {
                    /*
                    ...
                    */
                    ...
                    Logger.getLogger(StreamLikeNotifSender.class.getName()).log(Level.SEVERE, null, ex);
                }
        }
        ...
        try {
            ...
            lu = p.formatIgnoreUserList(senderId, lu, "", (String) args[0]);
