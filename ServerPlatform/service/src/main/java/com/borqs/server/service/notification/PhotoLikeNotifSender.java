...
public class PhotoLikeNotifSender extends NotificationSender {
    ...
    public PhotoLikeNotifSender(Platform p, Qiupu qiupu) {
        super(p, qiupu);
        isReplace = true;
    }
    ...
    protected List<Long> getScope(String senderId, Object... args) {
        ...
        if (getSettingKey().equals(Constants.NTF_PHOTO_LIKE)) {
            try {
                ...
                Logger.getLogger(PhotoLikeNotifSender.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
