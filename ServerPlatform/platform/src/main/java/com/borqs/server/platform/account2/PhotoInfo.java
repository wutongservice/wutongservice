...
public class PhotoInfo implements StringablePropertyBundle, JsonBean, Copyable<PhotoInfo> {
    ...
    public void addUrlPrefix(String prefix) {
        ...
        middleUrl = StringHelper.addPrefix(middleUrl, prefix,"%s/",null, true);
        smallUrl = StringHelper.addPrefix(smallUrl, prefix,"%s/", null,true);
        largeUrl = StringHelper.addPrefix(largeUrl, prefix,"%s/",null, true);
    }
    public void addDefualtUrlPrefix(String prefix) {
        ...
        middleUrl = StringHelper.addPrefix(middleUrl, prefix,"%s/","1.gif", true);
        smallUrl = StringHelper.addPrefix(smallUrl, prefix,"%s/","1.gif", true);
        largeUrl = StringHelper.addPrefix(largeUrl, prefix,"%s/","1.gif", true);
    }
