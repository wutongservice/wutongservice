...
import com.borqs.server.service.platform.Setting;
...
public abstract class SettingBase extends RPCService implements Setting {

    protected final Schema settingSchema = Schema.loadClassPath(SettingBase.class, "setting.schema");
    ...
    @Override
    public void init() {
        settingSchema.loadAliases(getConfig().getString("schema.setting.alias", null));
    }
