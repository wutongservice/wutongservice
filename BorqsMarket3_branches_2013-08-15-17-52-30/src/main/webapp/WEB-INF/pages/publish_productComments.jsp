    ...
    <div class="container">
        <div class="row">
            ...
            <div class="span8 offset2" id="content" style="text-align: right">
                ...
                <hr>
                <div class="span8 text-left" style="margin-left: 0;">
                    <div class="tab-content">
                        <c:forEach items="${records}" var="record">
                            <div class="comment">
                                <div class="row-fluid">
                                    <strong class="span2">${record.account_id}</strong>
                                    <small class="span4"><spring:message code="comment.text.commentDate"/>: ${bm:datetimeToStr(pageContext, record.updated_at)}</small>
                                    <span class="span2 pull-right rateit" data-rateit-value="${record.rating}"
