...
#sed 's/development/testing/g' notifications_php_web/bmb.conf.bak | sed "s/\/home\/liuchunrong\/workspace\/notifications/$CMHOME/g" | sed 's/8580/9580/g' > notifications_php_web/bmb.conf
...
#cp notifications-server/conf/test.properties notifications-server/conf/test.properties.bak
#sed 's/8083/9083/g' notifications-server/conf/test.properties.bak > notifications-server/conf/test.properties
...
sed 's/local.properties/test.properties/g' notifications-server/conf/applicationContext.xml.bak |sed "s/file:./file:$CMHOME\/notifications-server/g" > notifications-server/conf/applicationContext.xml
cat notifications-server/conf/applicationContext.xml

#cp notifications_php_web/application/configs/application.ini notifications_php_web/application/configs/application.ini.bak
#sed 's/local.properties/test.properties/g' notifications_php_web/application/configs/application.ini.bak > notifications_php_web/application/configs/application.ini
