...
struct Info {
	...
	// client scene
    22:optional string scene;

    // imageUrl
    23:optional string imageUrl;
}
...
struct NotificationUnreadResult {
	1:optional string scene;
	2:optional string readcount;
}
...
service INotificationsThriftService {
	...
	list<Info> listByTime(1:required string receiverId,
						  ...
						  3:optional i64 from=0,
						  4:optional i32 count=20);
	list<Info> userListByTime(1:required string receiverId,
    					  2:optional string status="0",
    					  3:optional i32 type=20,
    					  4:optional string scene="0",
    					  5:optional i64 from=0,
    					  6:optional i32 count=20);
    list<Info> userReadListByTime(1:required string receiverId,
        					  2:optional string status="0",
        					  3:optional i32 type=20,
        					  4:optional i32 read=20,
        					  5:optional string scene="0",
        					  6:optional i64 from=0,
        					  7:optional i32 count=20);
    ...
    list<Info> userTop(
    				...
    				2:required string receiverId,
    				3:optional string status="0",
    				4:optional i32 type=20,
    				5:optional string scene="0",
    				6:optional i32 topn=5);
	list<Info> topOfApp(
				1:required string appId, 
				2:required string receiverId,
				3:optional string status="0",
	...
	list<NotificationUnreadResult> getUnReadResultByScene(1:required string userId,2:optional string scene);
}