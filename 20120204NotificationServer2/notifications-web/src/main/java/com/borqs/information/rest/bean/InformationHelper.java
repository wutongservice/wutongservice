...
public class InformationHelper {
	...
	public static List<Information> convertToInformations(List<Info> infos) {
		List<Information> informations = new ArrayList<Information>();
		if(null==infos) return informations;
		
		for(Info info: infos) {
			Information information = convertToInformation(info);
