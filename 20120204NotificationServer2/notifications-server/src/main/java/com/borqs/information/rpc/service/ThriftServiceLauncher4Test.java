...
public class ThriftServiceLauncher4Test {
	...
	public void init(String[] args) throws Exception {
		...
		URL location = ThriftServiceLauncher4Test.class.getProtectionDomain().getCodeSource().getLocation();
		String path = location.getPath();
		System.out.println("class location is:"+path);
		
		URI uri = new File("F:\\work\\notif\\20120204NotificationServer2\\notifications-server-assembly").toURI();
...
//				};
	...
	//used for windows
	private static ThriftServiceLauncher4Test launcher = new ThriftServiceLauncher4Test();
