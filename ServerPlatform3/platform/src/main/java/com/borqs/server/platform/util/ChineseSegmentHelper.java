...
public class ChineseSegmentHelper {
        ...
        try {
            ...
            for (;;) {
                ...
                if (hasMinEnglishWordLength) {
                    if (StringHelper.isEnglishWord(s)&& s.length() < opts.minEnglishWordLength)
                        b = false;
                }
                if (b)
                    l.add(s);
            ...
            throw new ServerException(E.CHSEG);
        } finally {
    ...
    public static String[] segmentNameArray(String text) {
        ...
        for (String s : a) {
            if (StringHelper.isEnglishWord(s)) {
                l.add(s);
            } else {
