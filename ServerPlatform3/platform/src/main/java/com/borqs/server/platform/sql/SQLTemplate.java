    ...
    private static String vstr(TemplateModel o) {
        try {
            if (o == null) {
                ...
                return Sql.sqlValue(((TemplateScalarModel) o).getAsString());
            } else {
                throw new TemplateModelException("Object type error");
            }
        } catch (TemplateModelException e) {
