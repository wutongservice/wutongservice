...
public class PhotoImageHelper {
    ...
    public static final String T120 = "120x120<";
    ...
    public static void savePhotoImage(SFS sfs, FileItem fi, String imageName, String file) {
        ...
        try {
            ImageMagickHelper.resize4(tmp, s, X320, null, null, l, X640, t, T120);
        } catch (Exception e) {
        ...
        try {
            ...
            sfs.writeFile(fileTName.toString(), t);
        } catch (Exception e) {
            ...
            FileUtils.deleteQuietly(new File(t));
