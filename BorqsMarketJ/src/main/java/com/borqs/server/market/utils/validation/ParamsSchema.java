...
public class ParamsSchema {
    ...
    public ValidateResult validateQuietly(Map<String, Object> params) {
    ...
    public ValidateResult validateQuietly(Map<String, Object> params, Map<String, Object> newParams) {
        if (params == null)
    ...
    public <PS extends Map<String, Object>> PS validate(PS params, PS newParams) throws ServiceException {
    ...
    public <PS extends Map<String, Object>> PS validate(PS params) throws ServiceException {
        return validate(params, params);
    }


    public <PS extends Params> PS validate(PS params, PS newParams) throws ServiceException {
        validate(params.getParams(), newParams.getParams());
        return newParams;
    }

    public <PS extends Params> PS validate(PS params) throws ServiceException {
        return validate(params, params);
    }
