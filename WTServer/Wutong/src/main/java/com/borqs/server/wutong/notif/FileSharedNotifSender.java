...
//    	return String.valueOf(findAppIdFromPostType((Integer)args[0]));
    ...
    public String getFileType(Context ctx, String lang, String type){
         String return_type = Constants.getBundleStringByLang(lang, "file.share.notif.file");
        if (type.equals(String.valueOf(Constants.AUDIO_POST)))
            return_type = Constants.getBundleStringByLang(lang, "file.share.notif.audio");
         if (type.equals(String.valueOf(Constants.VIDEO_POST)))
            return_type = Constants.getBundleStringByLang(lang, "file.share.notif.video");
        return return_type;
    }
    ...
    public String getTitle(Context ctx, String lang, Object... args) {
        ...
        String sType = getFileType(ctx, lang, String.valueOf(args[0]));
