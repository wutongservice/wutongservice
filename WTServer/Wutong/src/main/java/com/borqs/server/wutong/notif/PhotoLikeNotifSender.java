...
public class PhotoLikeNotifSender extends NotificationSender {
	private String displayNames = "";
    private String nameLinks = "";

    public PhotoLikeNotifSender() {
        super();
        isReplace = true;
    }
    ...
    protected List<Long> getScope(Context ctx, String senderId, Object... args) {
        ...
        if (getSettingKey(ctx).equals(Constants.NTF_PHOTO_LIKE)) {
                List<String> reasons = new ArrayList<String>();
                reasons.add(String.valueOf(Constants.C_PHOTO_SHARE));
                reasons.add(String.valueOf(Constants.C_PHOTO_LIKE));
            ...
            RecordSet conversation_users = conversation.getConversation(ctx, Constants.PHOTO_OBJECT, (String) args[0], reasons, 0, 0, 100);
                ...
                reasons1.add(String.valueOf(Constants.C_PHOTO_LIKE));
   ...
   @Override
    protected String getSettingKey(Context ctx) {
        return Constants.NTF_PHOTO_LIKE;
    }
    ...
    protected String getTitle(Context ctx, String lang, Object... args) {
        ...
        String returnString = "";
        if (getSettingKey(ctx).equals(Constants.NTF_PHOTO_LIKE)) {
        	returnString = displayNames + "赞了照片";
        }
        return returnString;
    }
