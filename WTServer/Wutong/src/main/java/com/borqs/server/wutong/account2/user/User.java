...
import com.borqs.server.wutong.account2.util.ColumnsExpander;
...
public class User extends Addons implements JsonBean, Copyable<User> {
    ...
    public static final String[] STANDARD_COLUMNS = {
            COL_USER_ID, COL_NAME, COL_NICKNAME, COL_TOP_POSTS, COL_TOP_NAME, COL_LANGUAGE, COL_STATUS,COL_STATUS_UPDATED_TIME ,COL_DISPLAY_NAME, COL_PHOTO, COL_LOGIN_EMAIL1, COL_LOGIN_EMAIL2, COL_LOGIN_EMAIL3, COL_LOGIN_PHONE1, COL_LOGIN_PHONE2, COL_LOGIN_PHONE3
    };
    ...
    public static final int KEY_LANGUAGE = 30;
    ...
    public void setLanguage(String language) {
        setProperty(COL_LANGUAGE, language);
    }

    public String getLanguage() {
        return getStringProperty(COL_LANGUAGE, null);
    }
