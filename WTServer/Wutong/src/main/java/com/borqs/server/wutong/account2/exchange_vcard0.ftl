...
function activeUser()
{
    ...
    var url = "http://${host}/account/create?" + login_param + "=" + login_name
            ...
            + "&gender=" + gender + "&group_id=" + groupId;
...
function bindUser()
{
    ...
    var url = "http://${host}/account/invite_bind?borqs_account=" + account
            + "&borqs_pwd=" + MD5(pwd) + "&login_name=" + login_name + "&group_id=" + groupId;
...
{
    var bind = document.form1.login_name.value;
    var pwd = document.form1.password.value;
    document.location = "http://${host}/qiupu/active_down?bind=" + bind + "&password=" + pwd;
}
</script>
</head>
