...
public class ImageMagickHelper {
    ...
    public static void rotate(String input,String output,String orientation){
        new ImageMagickCommand(input, output).rotate(ObjectUtils.toString(orientation, DEFAULT_ROTATE)).checkRun();
    }
}
