...
public class PageTemplate {
    ...
    public PageTemplate(String... dirs) {
        try {
            ...
            throw new ServerException(BaseErrors.PLATFORM_INIT_TEMPLATES_ERROR, e);
        }
    }
    ...
    public Template getTemplate(String templateName) {
        try {
            ...
            throw new ServerException(BaseErrors.PLATFORM_LOAD_TEMPLATE_ERROR, e);
        }
    }
    ...
    public void merge(Writer out, String templateName, Map<String, Object> params) {
        ...
        try {
            ...
            throw new ServerException(BaseErrors.PLATFORM_MERGE_TEMPLATE_ERROR, e);
        } catch (IOException e) {
            throw new ServerException(BaseErrors.PLATFORM_MERGE_TEMPLATE_ERROR, e);
        }
    }
