...
public class XMemcachedOnlineStatus implements Initializable {
    private static final Logger L = Logger.getLogger(XMemcachedOnlineStatus.class);
...
//        Configuration conf = getConfig();
        try {
            client = new XMemcachedClient(conf.getString("platform.memcacheServerIpAddr", "localhost"), Integer.valueOf(conf.getString("platform.memcacheServerPortAddrOnlineStatus", "11212")));
        } catch (IOException e) {
