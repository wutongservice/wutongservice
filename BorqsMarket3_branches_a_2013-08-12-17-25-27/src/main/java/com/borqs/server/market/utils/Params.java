...
public class Params {
    ...
    public String getString(String name, String defaultStr) {
        return StringUtils.isBlank((String) params.get(name)) ? defaultStr : (String) params.get(name);
    }

    public Integer getInt(String name, Integer defaultInt) {
        return  params.get(name) == null ? defaultInt : Integer.parseInt((String)params.get(name)) ;
    }
