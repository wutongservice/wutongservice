...
<form method="POST" class="form-horizontal" enctype="multipart/form-data" accept-charset="UTF-8"
      action="/publish/apps/${result['app_id']}/upload/fill_manifest">
    ...
    <div class="controls ${controlsSpan}">
      <select type="text" id="category_id" name="category_id" class="span12">
        <c:forEach items="${categories}" var="categoryItem">
          <option value="${categoryItem['category_id']}" ${categoryItem['category_id'] eq result['category_id'] ? 'selected' : ''}>
...
<div class="row-fluid">
  <bm:textInput id="tags" name="tags"
                ...
                value="${result['tags']}" errorMessage="${result['tags_name_errorMessage']}"
