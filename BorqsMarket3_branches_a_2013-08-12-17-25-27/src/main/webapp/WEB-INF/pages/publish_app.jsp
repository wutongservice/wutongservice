    ...
    <div class="span8 offset2" id="content">
      <div class="row-fluid">
        <div class="span12" style="margin-top:20px;">
          <a class="btn btn-success btn-large pull-right" href="/publish/apps/${currentAppId}/upload">
            <i class="icon-white icon-plus"></i>
            <strong><spring:message code="AppNavigationBarTag.button.newProduct"/></strong>
          </a>
        </div>
      </div>
      <hr>
            ...
            <div class="tab-pane ${tabActive}" id="${products.key}">
              ...
              <c:if test="${empty products.value.products}">
                <div class="well" style="height:200px;">
                  <p><spring:message code="publish_app.text.emptyProductsTip"/></p>
                </div>
              </c:if>
            </div>
          </c:forEach>
