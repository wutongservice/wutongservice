...
<div class="span2 offset10 affix">
  ...
  <ul id="actionList">
    <li>
      <a class="btn btn-warning" href="/publish/products/${product['id']}/price">
    ...
    <li>
      <a class="btn btn-info" href="${version['url']}" download="${version['url_filename']}">
        <i class="icon-white icon-download"></i>&nbsp;<strong><spring:message
          code="publish_product.button.downloadVersion"/></strong>
      </a>
    </li>
...
<fieldset>
  ...
  <p class="badge badge-info"><strong>${product['id']}(${version['version']})</strong></p>
  <hr class="hr2">
  <div class="row-fluid">
  ...
  <hr>
  <div class="row-fluid">
    <bm:textInput id="tags" name="tags"
                  label="${bm:springMessage(pageContext, 'publish_product.label.tags')}"
                  value="${product['tags']}" errorMessage="${product['tags_name_errorMessage']}"
                  readonly="false" inputSpan="span12" required="false"/>
  </div>
